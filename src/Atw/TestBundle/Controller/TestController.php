...
use Atw\TestBundle\Entity\Test;
use Atw\TestBundle\Form\TestType;
...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AtwTestBundle:Test')->findAll();
     ...
     * @Method("POST")
     * @Template("AtwTestBundle:Test:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AtwTestBundle:Test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AtwTestBundle:Test:edit.html.twig")
     */
